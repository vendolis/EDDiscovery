...
namespace EDDiscovery
{
    public partial class TravelHistoryControl : UserControl
    {
        ...
        public void RefreshHistory()
        {
            ...
            {    
                var item = result[ii];
                var item2 = ii < result.Count - 1 ? result[ii + 1] : null;
        ...
        private void ShowSystemInformation(SystemPosition syspos)
        {
            ...
            _discoveryForm.TrilTabEnabled = !syspos.curSystem.HasCoordinate && syspos.curSystem == GetCurrentSystem();
        ...
        internal void NewPosition(object source)
        {
            try
            {
                ...
                Invoke((MethodInvoker)delegate
                {
                    ...
                    _discoveryForm.TrilTabEnabled = false; // when we arrive to new system, currently opened SystemInformation will _always_ be for non-current system
...
//            tctrl.TargetSystem = CurrentSystem;
